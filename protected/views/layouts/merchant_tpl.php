...
<div class="header_wrap">
  ...
  href="https://api.qrserver.com/v1/create-qr-code/?size=1024x1024&data=https://kinago.com<?php echo Yii::app()->request->baseUrl."/menu-".$merchant_info[0]->restaurant_slug;?>">
