...
<div id="search-listview" class="col-md-6 border infinite-item <?php echo $delivery_fee!=true?'free-wrap':'non-free'; ?>">
    <div class="inner">
        ...
        <div class="mytable">
          <div class="mycol a"><p class="buzname concat-text shiftleft"><?php echo clearString($val['restaurant_name'])?> <?php echo clearString($val['merchant_website'])?></p>
         <p class="concat-text3 shiftleft">
        <i><?php echo FunctionsV3::displayCuisine($val['cuisine']);?></i>
        </p></div>
        ...
        <div class="mytable" style="margin-top:-10px;text-align:left!important;padding:5px">
	        ...
	        if(!$search_by_location){		        
		        echo Yii::t("default","<div style='font-size:12px!important;'><i class='fa fa-location-arrow' aria-hidden='true'></i> [distance]</div>",array(
		          '[distance]'=>$distance
		        ));
	        }
	        ?></div> 
	        ...
	        <p class="top15" style="display:none;"><?php echo FunctionsV3::getFreeDeliveryTag($merchant_id)?></p>
	         </div>
