...
<div id="search-listview" class="col-md-6 border infinite-item <?php echo $delivery_fee!=true?'free-wrap':'non-free'; ?>">
    <div class="inner">
        ...
        <div class="mytable">
          <div class="mycol a"><p class="concat-text shiftleft"><?php echo clearString($val['restaurant_name'])?></p>
        <p class="concat-text shiftleft"><?php echo $val['merchant_address']?></p>
