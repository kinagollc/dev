...
<div class="menu-1 box-grey rounded" style="margin-top:0;">
  ...
  <div class="menu-cat cat-<?php echo $val['category_id']?> ">
    ...
    <a href="#" data-featherlight="<?php echo FunctionsV3::getFoodDefaultImage($val_item['photo'],false)?>" class="dsktop menu-item <?php echo $val_item['not_available']==2?"item_not_available":''?>"><img src="<?php echo FunctionsV3::getFoodDefaultImage($val_item['photo'],false)?>" style="border-radius:10px;"></a>
