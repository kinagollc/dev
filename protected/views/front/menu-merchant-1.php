  ...
  <div class="menu-cat cat-<?php echo $val['category_id']?> ">
    ...
    <a href="<?php echo FunctionsV3::getFoodDefaultImage($val_item['photo'],false)?>" target="_blank" class="dsktop menu-item <?php echo $val_item['not_available']==2?"item_not_available":''?>" 
            ...
            data-category_id="<?php echo $val['category_id']?>"><img src="<?php echo FunctionsV3::getFoodDefaultImage($val_item['photo'],false)?>" style="border-radius:10px;"></a>
             ...
             <a href="<?php echo FunctionsV3::getFoodDefaultImage($val_item['photo'],false)?>" target="_blank" class="mbile menu-item <?php echo $val_item['not_available']==2?"item_not_available":''?>"><img src="<?php echo FunctionsV3::getFoodDefaultImage($val_item['photo'],false)?>" style="border-radius:10px;"></a>
