...
class IndexController extends CController
{
	...
	{			
	    ...
	    /*1.8.2 UPDATE*/
	    if( !DatataseMigration::checkFields("{{driver_task_view}}",array('driver_vehicle')) ){
	    	$this->redirect(Yii::app()->createUrl(APP_FOLDER.'/update'));
			Yii::app()->end();
	    }
	    
	    /*1.8.4 UPDATE*/
	    if( !DatataseMigration::checkFields("{{driver_task_view}}",array('delivery_instruction')) ){
	    	$this->redirect(Yii::app()->createUrl(APP_FOLDER.'/update'));
			Yii::app()->end();
	    }
