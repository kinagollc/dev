 ...
 <div class="form-group">
	 ...
	 <div class="form-group">
	    ...
	    <div class="col-sm-2">
	      ...
	      ?>	
	      <p class="text-muted top5"><?php echo Driver::t("in seconds, Default is 10 seconds")?></p>	            
	    </div>
	  </div>	     
	 ...
	 <div class="form-group">
	  ...
	  <h4 style="font-weight:600;"><?php echo Driver::t("Privacy policy")?></h4>	  

	   <div class="form-group">
	    <label class="col-sm-2 control-label"><?php echo Driver::t("Link")?></label>
	    <div class="col-sm-5">
	      <?php
	      echo CHtml::textField('driver_privacy_policy_link',
	      getOptionA('driver_privacy_policy_link')
	      ,array(
	       'class'=>"form-control"
	      ))
	      ?>	
	      <p class="text-muted top5"><?php echo Driver::t("Your privacy policy website link")?></p>	            
	    </div>
	  </div>	     
