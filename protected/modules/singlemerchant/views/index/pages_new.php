...
<a href="<?php echo Yii::app()->createUrl('/singlemerchant/index/merchant_settings',array(
 'merchant_id'=>$merchant_id
))?>" class="pad5 block">
<i class="fa fa-long-arrow-left"></i> <?php echo SingleAppClass::t("Back")?></a>
...
<h3><?php echo Yii::t("singleapp","Add new page for merchant [merchant_name]",array(
  ...
  <div class="tab-pane active" id="default">
    ...
    <div style="padding:10px;">
       ...
       <div class="form-group">
	    <label ><?php echo SingleAppClass::t("Title")?></label>
	    <?php 
	  ...
	  <div class="form-group">
	    <label ><?php echo SingleAppClass::t("Content")?></label>
	    <?php 
...
<?php else :?>
 ...
 <?php endif;?>
  ...
  <div class="form-group">
    <label ><?php echo SingleAppClass::t("Icon")?></label>
    <?php 
    echo CHtml::textField('icon',
    isset($data['icon'])?stripslashes($data['icon']):''
    ,array(
      'class'=>'form-control', 
      'placeholder'=>SingleAppClass::t("example")." ion-help-circled"
    ));
    ?>
  </div>
  <p><?php echo SingleAppClass::t("Get your icon in")?> 
  <a target="_blank" href="http://ionicons.com/">http://ionicons.com/</a> </p>
  
  <div class="form-group">
    <label><?php echo SingleAppClass::t("HTML format")?> </label>
    <?php 
  ...
  <div class="form-group">
    <label ><?php echo SingleAppClass::t("Sequence")?></label>
    <?php 
  ...
  <div class="form-group">
    <label ><?php echo SingleAppClass::t("Status")?></label>
    <?php 
...
echo CHtml::ajaxSubmitButton(
	...
	array(
		...
		'beforeSend'=>'js:function(){
		                 busy(true); 	
		                 $("#submit").val("'.SingleAppClass::t("Processing").'");
		                 $("#submit").css({ "pointer-events" : "none" });	                 
		              }
		',
		'complete'=>'js:function(){
		                 busy(false); 		 
		                 $("#submit").val("'.SingleAppClass::t("Save").'");                
