...
<div class="table_search_wrap">
  ...
  echo CHtml::textField('search_fields','',array(
   'placeholder'=>st("Search name, platform,uiid and device id"),
   'class'=>"form-control"
  ));
  ?>
...
<table id="table_list" class="table data_tables">
 <thead>
  <tr>
   <th><?php echo st("ID")?></th>
   <th><?php echo st("Name")?></th>
   <th><?php echo st("Platform")?></th>
   <th><?php echo st("UIID")?></th>
   <th><?php echo st("Device ID")?></th>
   <th><?php echo st("Push Enabled")?></th>
   <th><?php echo st("Subribe alert")?></th>
   <th width="10%"><?php echo st("Date Created")?></th>
   <th width="10%"><?php echo st("Last Login")?></th>
   <th width="10%"><?php echo st("Actions")?></th>
  </tr>
 </thead>
 <tbody>  
 </tbody>
...
<div>
 <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header"> <h5 class="modal-title" ><?php echo st("Send Push Notification")?></h5></div>
        ...
        <div class="modal-footer">
          ...
          <button type="submit" class="btn <?php echo APP_BTN;?>"><?php echo st("Send Push")?></button>
       </div>
