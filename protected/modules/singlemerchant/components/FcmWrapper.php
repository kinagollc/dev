...
class FcmWrapper
{
	...
	public static function ServiceAccount($file='',$option_token='', $merchant_id=0)
	{
		 self::$_file = $file;
	...
	public static function generateToken($client)
	{
	    ...
	    Yii::app()->functions->updateOption(self::$_option_token,
	       json_encode($accessToken),self::$_merchant_id
	    );
	    return $accessToken;
	}
	...
	{		
		...
		$save_access_token = getOption(self::$_merchant_id,self::$_option_token);		
