...
function initReadMore()
{
	if ( $(".read-more").exists() ){				
	    $('.read-more').readmore({
	    	moreLink:'<a class="small" style="font-size:11px;font-weight:bold;position:inherit;" href="javascript:;">'+js_lang.read_more+'</a>',
	    	lessLink:'<a class="small" style="font-size:11px;font-weight:bold;position:inherit;" href="javascript:;">'+js_lang.close+'</a>'
	    });
	}
}
